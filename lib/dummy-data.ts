...
export const insights = [
  {
    title: "Your coffee habit",
    text: "You spent $124 on coffee this month — 18% more than May.",
    tag: "Spending pattern",
    tone: "orange" as const,
  },
  {
    title: "Nice work, Alex",
    text: "You are on track to save $320 this month if you keep your current pace.",
    tag: "Positive trend",
    tone: "green" as const,
  },
  {
    title: "Subscription check",
    text: "You have 7 active subscriptions. Two have not been used in 30 days.",
    tag: "Opportunity",
